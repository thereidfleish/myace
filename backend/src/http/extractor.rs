...
impl AuthUser {
    ...
    fn from_authorization(ctx: &ApiContext, auth_header: &HeaderValue) -> Result<Self, Error> {
        ...
        // Using SHA-384 (HS-384) as the HMAC, as it is more difficult to brute-force
...
// boilerplate.
#[async_trait]
impl FromRequest<axum::body::Body> for AuthUser {
...
#[async_trait]
impl FromRequest<axum::body::Body> for MaybeAuthUser {
    type Rejection = Error;
