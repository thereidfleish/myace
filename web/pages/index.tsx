    ...
    <MarketingLayout>
      <div className="mx-auto min-h-[95vh] flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
        <h1 className="text-4xl font-bold leading-none sm:text-5xl">
          Next generation <span className="text-primary-dark">athletic training</span> for your club
        </h1>
        <p className="px-8 mt-8 mb-12 text-lg">MyAce is social platform bringing coaches, players, and parents together.
        </p>
        <div className="flex flex-wrap justify-center py-2">
          <Link href="/login">
            <button className="px-8 py-3 m-2 text-lg font-semibold rounded bg-primary-dark text-gray-900 hover:bg-violet-300 transition-all duration-300">Sign in</button>
          </Link>
          <Link href="#timeline">
            <button className="px-8 py-3 m-2 text-lg border rounded text-gray-50 border-gray-700 hover:border-gray-600 transition-all duration-300">Learn more</button>
          </Link>
